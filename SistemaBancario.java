            ...
            switch (opcaoContas) {
                    ...
                    do {
                        ...
                        switch (opcao) {
                            ...
                            case 2:
                                ...
                                contas.consultarSaldo(cpfsCorrente, saldosCorrente, cpf1);
                                break;
                            case 3:
                                System.out.println("Digite seu cpf, para acessar sua conta: ");
                                scanner.nextLine();
                ...
                case 2:
                    do {
                        ...
                        switch (opcao2) {
                            case 1:
                                contas.gerarConta(cpfsPoupanca, contaBancariasPoupanca, nomesPoupanca, idadesPoupanca, saldosPoupanca, contasNumerosPoupanca);
                            ...
                            case 2:
                                ...
                                scanner.nextLine();
                                String cpf1 = scanner.nextLine();
                                contas2.consultarSaldo(cpfsPoupanca, saldosPoupanca, cpf1);
                                break;
                            case 3:
                                System.out.println("Digite seu cpf, para acessar sua conta: ");
                                scanner.nextLine();
